      ...
      <div className={ClientSignupstyles.limiter+" h-full"}>
		<div className={ClientSignupstyles.containerlogin100}>
			<div className={ClientSignupstyles.wraplogin100+" p-t-30 p-b-50"}>
				<span className={ClientSignupstyles.login100formtitle+" p-b-41 p-6"}>
					WELCOME TO ARMOR
				</span>
        ...
        <span>Contact details</span>
          ...
          <div  className="text-center justify-center p-4">
						<input defaultValue={fields.name} className={ClientSignupstyles.input100} onChange={(e) => handleInputChange(e, "name")} placeholder="Name"/>
                        {nameErr &&
  <span className="text-red-600 text-md">Please add name name</span>}
            </div>
            <div  className="text-center justify-center p-4">
          <input defaultValue={fields.company} className={ClientSignupstyles.input100} onChange={(e) => handleInputChange(e, "company")}placeholder="Company Name" />
          {companyErr &&
  <span className="text-red-600 text-md">Please add company name</span>}
          </div>
          <div  className="text-center justify-center p-4">
          <input defaultValue={fields.email} className={ClientSignupstyles.input100} onChange={(e) => handleInputChange(e, "email")} placeholder="Email" />
          {emailErr &&
  <span className="text-red-600 text-md">Please add Email Id</span>}
          </div>
          <div className="text-center justify-center p-4">
          <input defaultValue={fields.contact} className={ClientSignupstyles.input100} onChange={(e) => handleInputChange(e, "contact")} placeholder="Contact" />
          {contactErr &&
